...
1] static block or STATIC INITIALIZER BLOCKS [S.I.B]
...
2] Non-static Block or Instance Initializier Block[I.I.B]

Any block which is not declrared using static keyword is called as non-static block.
...
-> We cannot name non-static blocks.
-> We can only get non static blocks executed.
-> Non-static blocks get executed when the object of the class is created.
-> Number of time the non-static blocks getting executed is directly proportional to the number of objects created for that class.
                             ->refer program nsb1.java<-

                    -> Applications of non-static blocks<-

1] Non-static blocks can be used to perform any mandatory task when ever the object of that class is created.    

2] Non-static blocks also can be used for initializing the data members of a class.Hence it is called as Instance Initializier Block[I.I.B].                
                             ->refer program nsb2.java<-
----------------------------------------------------------------------------
