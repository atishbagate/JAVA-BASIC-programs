...
-> class data-members declared with final keyword can be inherited but cannot be re-initialized. 

-> class function-members declared with final keyword can be inherited but cannot be re-initialized.
...
1] Single/simple inheritance
One subclass inheriting the properties from one superclass is known as single/simple inheritance.   

------------------------------------------------------------------------------------

2] Multilevel inheritance
One subclass inherits properties from one superclass where that superclass inherits properties from another superclass. 
...
final keyword is not same as static
