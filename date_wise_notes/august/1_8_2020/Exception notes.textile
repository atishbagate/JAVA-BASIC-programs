...
throws key should always be used with the method/constructor declration.
...
----------------------------------------------------------------------------------------------------------
2] throw -> throw is used by the programmer explicitly to pass the exception object from the called function to the calling function.

throw can only propagate unchecked exceptions. 

throw keyword can be used inside the method/constructor body/definition.
...
a.s   a.m   r.t  f.n(a.l)
{
      ...
      create exceptionClass Object and use throw key to throw the exception

      throw exceptionClassRefVar;
