 ...
 * to create a laptop object by taking laptop model which is String data.
 * Laptop Model Id which is int data.
 * Laptop Ram capacity which is int data in GBs.
 * Laptop Rom capacity which is int data in GBs.
 * Laptop Manufacturing date which is in String and format mm/dd/yyyy.
 * Laptop showroom Id which is String data and format ShowroomName followed by Id.
 * Laptop Customer Id which is String data and format CustomerName followed by Id.
 */
